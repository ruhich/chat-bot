...
function getBotResponse(message) {
	const responses = {
		...
		'хочешь погулять?':
			'прости, но я не могу гулять с тобой, я всего лишь бот(',
		'паритет легенда?':
			'Да, он лучший айтишник до 15 лет, я если его увижу автограф возьму!',
		'давай поговорим' : 'Давай, о чем хочешь поболтать?' ,
		'как тебе погода?' : 'Погода прекрасная' ,
	}
